...
const zh: Messages = {
    ...
    preview: {
        ...
        pasteImagePathPlaceholder: '相对路径与文件名（相对当前 .md 所在目录）',
        pasteImagePathPrompt: '输入保存路径与文件名',
        pasteImageInsertTypeRef: '引用文件',
        pasteImageInsertTypeBase64: 'Base64 内联',
...
const en: Messages = {
    ...
    preview: {
        ...
        pasteImagePathPlaceholder: 'Path and filename (relative to current .md)',
        pasteImagePathPrompt: 'Enter save path and filename',
        pasteImageInsertTypeRef: 'Reference file',
        pasteImageInsertTypeBase64: 'Base64 inline',
