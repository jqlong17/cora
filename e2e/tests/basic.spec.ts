 ...
 * 比集成测试更接近真实用户操作
 */
test.describe('Cora Basic E2E Tests', () => {
...
test.describe('Cora Page Tree Tests', () => {
  test('should have test workspace files', async () => {
    ...
    expect(files).toContain('项目文档.md');
  });
});

test.describe('Cora Search Tests', () => {
  test('test files should have searchable content', async () => {
    const fs = require('fs');
 ...
 * - 发布前进行完整的功能测试
 */
test.describe.skip('Advanced UI Tests (require running VS Code)', () => {
  test('should open Cora sidebar', async () => {
